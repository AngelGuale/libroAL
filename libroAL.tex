...
\item Existe un elemento de $V$, llamado elemento nulo y denotado por $0_v$, tal que para todo $u$ en $V$, $u + 0_v = 0_v +u = u$.
\item Para cada $u$ en $V$ existe un único elemento en $V$, llamado $-u$, tal que $u+(-u)=0_v$.
\end{enumerate}
